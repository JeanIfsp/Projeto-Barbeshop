...
from barbershop.services import ServicePrice, ServiceAppointment, ServiceReport
from barbershop.utils import  retrieve_month_names
from barbershop.utils_report import extract_month_count_data, extract_week_count_data, extract_month_amount_data
...
def recover_data(request):
    ...
    try:
        ...
        data_by_month_and_type = service_report.get_data_by_month_number_nad_type_id(month_number, type_id)
        data = extract_month_count_data(data_by_month_and_type)
